...
import * as Namespace from '../../../../../server/src/instrument/provider/smu'
...
@suite class SmuTest {
    ...
    exportsCompletions(): void {
        assert(
            ...
            'Expected Smu to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Smu'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Unexpected signatures export from Smu'
        )
    }
}
