...
import { InstrumentSignatureInformation } from '../../../../../server/src/instrument/provider'
import * as Namespace from '../../../../../server/src/instrument/provider/smu-measure-configlist'
import { emptySpec } from '../emptySpec'

@suite class SmuMeasureConfiglistTest {
    @test('Exports completions')
    exportsCompletions(): void {
        assert(
            Namespace.completions !== undefined,
            'Expected Smu-Measure-Configlist to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Smu-Measure-Configlist'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Expected Smu-Measure-Configlist to export signatures'
        )
    }
