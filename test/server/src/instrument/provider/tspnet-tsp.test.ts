...
import * as Namespace from '../../../../../server/src/instrument/provider/tspnet-tsp'
import { emptySpec } from '../emptySpec'

@suite class TspnetTspTest {
    @test('Exports completions')
    exportsCompletions(): void {
        assert(
            Namespace.completions !== undefined,
            'Expected Tspnet-Tsp to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Tspnet-Tsp'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Expected Tspnet-Tsp to export signatures'
        )
    }
