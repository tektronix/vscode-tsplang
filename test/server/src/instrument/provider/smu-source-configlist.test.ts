...
import * as Namespace from '../../../../../server/src/instrument/provider/smu-source-configlist'
import { emptySpec } from '../emptySpec'

@suite class SmuSourceConfiglistTest {
    @test('Exports completions')
    exportsCompletions(): void {
        assert(
            Namespace.completions !== undefined,
            'Expected Smu-Source-Configlist to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Smu-Source-Configlist'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Expected Smu-Source-Configlist to export signatures'
        )
    }
