...
import * as Namespace from '../../../../../server/src/instrument/provider/trigger-tsplinkin'
import { emptySpec } from '../emptySpec'

@suite class TriggerTsplinkinTest {
    @test('Exports completions')
    exportsCompletions(): void {
        assert(
            Namespace.completions !== undefined,
            'Expected Trigger-Tsplinkin to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Trigger-Tsplinkin'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Expected Trigger-Tsplinkin to export signatures'
        )
    }
