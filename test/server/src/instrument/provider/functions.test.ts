...
import * as Namespace from '../../../../../server/src/instrument/provider/functions'
import { emptySpec } from '../emptySpec'

@suite class FunctionsTest {
    @test('Exports completions')
    exportsCompletions(): void {
        assert(
            Namespace.completions !== undefined,
            'Expected Functions to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Functions'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Expected Functions to export signatures'
        )
    }
