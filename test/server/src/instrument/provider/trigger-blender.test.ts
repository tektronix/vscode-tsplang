...
import * as Namespace from '../../../../../server/src/instrument/provider/trigger-blender'
import { emptySpec } from '../emptySpec'

@suite class TriggerBlenderTest {
    @test('Exports completions')
    exportsCompletions(): void {
        assert(
            Namespace.completions !== undefined,
            'Expected Trigger-Blender to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Trigger-Blender'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Expected Trigger-Blender to export signatures'
        )
    }
