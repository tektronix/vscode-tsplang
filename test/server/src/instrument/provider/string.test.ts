...
import * as Namespace from '../../../../../server/src/instrument/provider/string'
...
@suite class StringTest {
    ...
    exportsCompletions(): void {
        assert(
            ...
            'Expected String to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from String'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Expected String to export signatures'
        )
    }
