...
import * as Namespace from '../../../../../server/src/instrument/provider/script'
...
@suite class ScriptTest {
    ...
    exportsCompletions(): void {
        assert(
            ...
            'Expected Script to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Script'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Expected Script to export signatures'
        )
    }
