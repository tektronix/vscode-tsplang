...
import * as Namespace from '../../../../../server/src/instrument/provider/status-questionable'
import { emptySpec } from '../emptySpec'

@suite class StatusQuestionableTest {
    @test('Exports completions')
    exportsCompletions(): void {
        assert(
            Namespace.completions !== undefined,
            'Expected Status-Questionable to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Status-Questionable'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Expected Status-Questionable to export signatures'
        )
    }
