...
import * as Namespace from '../../../../../server/src/instrument/provider/status-standard'

@suite class StatusStandardTest {
    @test('Exports completions')
    exportsCompletions(): void {
        assert(
            Namespace.completions !== undefined,
            'Expected Status-Standard to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Status-Standard'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Unexpected signatures export from Status-Standard'
        )
    }
}
