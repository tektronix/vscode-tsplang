...
import * as Namespace from '../../../../../server/src/instrument/provider/node'
...
@suite class NodeTest {
    ...
    exportsCompletions(): void {
        assert(
            ...
            'Expected Node to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Node'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Expected Node to export signatures'
        )
    }
