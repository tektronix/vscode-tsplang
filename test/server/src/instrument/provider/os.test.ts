...
import * as Namespace from '../../../../../server/src/instrument/provider/os'
...
@suite class OsTest {
    ...
    exportsCompletions(): void {
        assert(
            ...
            'Expected OS to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from OS'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Expected OS to export signatures'
        )
    }
