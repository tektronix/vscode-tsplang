...
import * as Namespace from '../../../../../server/src/instrument/provider/printnumber'
import { emptySpec } from '../emptySpec'

@suite class PrintnumberTest {
    @test('Exports completions')
    exportsCompletions(): void {
        assert(
            Namespace.completions !== undefined,
            'Expected Printnumber to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Printnumber'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Expected Printnumber to export signatures'
        )
    }
