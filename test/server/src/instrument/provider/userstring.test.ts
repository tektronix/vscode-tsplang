...
import * as Namespace from '../../../../../server/src/instrument/provider/userstring'
import { emptySpec } from '../emptySpec'

@suite class UserstringTest {
    @test('Exports completions')
    exportsCompletions(): void {
        assert(
            Namespace.completions !== undefined,
            'Expected Userstring to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Userstring'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Expected Userstring to export signatures'
        )
    }
