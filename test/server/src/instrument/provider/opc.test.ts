...
import * as Namespace from '../../../../../server/src/instrument/provider/opc'
...
@suite class OpcTest {
    ...
    exportsCompletions(): void {
        assert(
            ...
            'Expected Opc to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Opc'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Unexpected signatures export from Opc'
        )
    }
}
