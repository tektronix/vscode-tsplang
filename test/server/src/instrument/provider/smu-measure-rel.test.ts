...
import * as Namespace from '../../../../../server/src/instrument/provider/smu-measure-rel'
import { emptySpec } from '../emptySpec'

@suite class SmuMeasureRelTest {
    ...
    exportsCompletionDocs(): void {
        assert(
            ...
            'Expected Smu-Measure-Rel to export completionDocs'
        )
    }
    ...
    exportsCompletions(): void {
        assert(
            ...
            'Expected Smu-Measure-Rel to export completions'
        )
    }
    ...
    exportsNoSignatures(): void {
        assert(
            ...
            'Unexpected signatures export from Smu-Measure-Rel'
        )
    }
}
