...
import * as Namespace from '../../../../../server/src/instrument/provider/scriptVar'
import { emptySpec } from '../emptySpec'

@suite class ScriptVarTest {
    @test('Exports completions')
    exportsCompletions(): void {
        assert(
            Namespace.completions !== undefined,
            'Expected ScriptVar to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from ScriptVar'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Expected ScriptVar to export signatures'
        )
    }
