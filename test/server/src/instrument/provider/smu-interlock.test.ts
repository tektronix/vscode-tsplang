...
import * as Namespace from '../../../../../server/src/instrument/provider/smu-interlock'
import { emptySpec } from '../emptySpec'

@suite class SmuInterlockTest {
    ...
    exportsCompletionDocs(): void {
        assert(
            ...
            'Expected Smu-Interlock to export completionDocs'
        )
    }
    ...
    exportsCompletions(): void {
        assert(
            ...
            'Expected Smu-Interlock to export completions'
        )
    }
    ...
    exportsNoSignatures(): void {
        assert(
            ...
            'Unexpected signatures export from Smu-Interlock'
        )
    }
}
