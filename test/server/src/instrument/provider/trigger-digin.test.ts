...
import * as Namespace from '../../../../../server/src/instrument/provider/trigger-digin'
import { emptySpec } from '../emptySpec'

@suite class TriggerDiginTest {
    @test('Exports completions')
    exportsCompletions(): void {
        assert(
            Namespace.completions !== undefined,
            'Expected Trigger-Digin to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Trigger-Digin'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Expected Trigger-Digin to export signatures'
        )
    }
