...
import * as Namespace from '../../../../../server/src/instrument/provider/smu-source-vlimit'
import { emptySpec } from '../emptySpec'

@suite class SmuSourceVlimitTest {
    ...
    exportsCompletionDocs(): void {
        assert(
            ...
            'Expected Smu-Source-Vlimit to export completionDocs'
        )
    }
    ...
    exportsCompletions(): void {
        assert(
            ...
            'Expected Smu-Source-Vlimit to export completions'
        )
    }
    ...
    exportsNoSignatures(): void {
        assert(
            ...
            'Unexpected signatures export from Smu-Source-Vlimit'
        )
    }
}
