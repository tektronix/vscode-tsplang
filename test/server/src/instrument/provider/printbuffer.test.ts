...
import * as Namespace from '../../../../../server/src/instrument/provider/printbuffer'
import { emptySpec } from '../emptySpec'

@suite class PrintbufferTest {
    @test('Exports completions')
    exportsCompletions(): void {
        assert(
            Namespace.completions !== undefined,
            'Expected Printbuffer to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Printbuffer'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Expected Printbuffer to export signatures'
        )
    }
