...
import * as Namespace from '../../../../../server/src/instrument/provider/createconfigscript'
import { emptySpec } from '../emptySpec'

@suite class CreateconfigscriptTest {
    @test('Exports completions')
    exportsCompletions(): void {
        assert(
            Namespace.completions !== undefined,
            'Expected Createconfigscript to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Createconfigscript'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Expected Createconfigscript to export signatures'
        )
    }
