...
import * as Namespace from '../../../../../server/src/instrument/provider/smu-source-protect'

@suite class SmuSourceProtectTest {
    @test('Exports completions')
    exportsCompletions(): void {
        assert(
            Namespace.completions !== undefined,
            'Expected Smu-Source-Protect to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Smu-Source-Protect'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Unexpected signatures export from Smu-Source-Protect'
        )
    }
}
