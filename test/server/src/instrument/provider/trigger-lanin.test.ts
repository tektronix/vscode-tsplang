...
import * as Namespace from '../../../../../server/src/instrument/provider/trigger-lanin'
import { emptySpec } from '../emptySpec'

@suite class TriggerLaninTest {
    @test('Exports completions')
    exportsCompletions(): void {
        assert(
            Namespace.completions !== undefined,
            'Expected Trigger-Lanin to export completions'
        )
    }
    ...
    exportsNoCompletionDocs(): void {
        assert(
            ...
            'Unexpected completionDocs export from Trigger-Lanin'
        )
    }
    ...
    exportsSignatures(): void {
        assert(
            ...
            'Expected Trigger-Lanin to export signatures'
        )
    }
