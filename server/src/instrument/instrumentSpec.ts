...
import { DefaultFillValue } from './defaultFillValue'

interface BeeperSpec {
    /**
     * 2450: 8000
     */
    maxHertz: number
...
interface MeasureResistanceSpec {
    /**
...
interface ExtendedOperatingArea extends OperatingArea {
    /**
     * 2461: 10
     */
...
interface RangeSpecDefiniteDefault {
    default: number
    high: number
    low: number
}

interface SmuContactSpec {
    /**
...
interface SmuMeasureAutorangeSpec {
