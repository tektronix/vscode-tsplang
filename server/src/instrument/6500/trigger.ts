...
const triggerCompletions: Array<CompletionItem> = [
    ...
    {
        detail: 'This function resets the edge, logic, and stimulus values for the EXTERNAL TRIGGER IN and EXTERNAL TRIGGER OUT lines to their default values.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'This function resets the following attributes to their default values:\n\nIt also clears trigger.extin.overrun.'
        },
        kind: CompletionItemKind.Function,
        label: 'trigger.ext.reset',
    },
    {
        detail: 'This function clears the trigger event on the EXTERNAL TRIGGER IN line.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'The event detector of a trigger enters the detected state when an event is detected. This command clears the event detector, discards the history, and clears the overrun status (sets the overrun status to false).'
        },
        kind: CompletionItemKind.Function,
        label: 'trigger.extin.clear',
    },
    {
        detail: 'This attribute sets the type of edge that is detected as an input on the EXTERNAL TRIGGER IN trigger line.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'The input state of EXTERNAL TRIGGER IN is controlled by the type of edge specified by this command.'
        },
        kind: CompletionItemKind.Property,
        label: 'trigger.extin.edge',
    },
    {
        detail: 'This attribute returns the event detector overrun status.',
        documentation: {
        ...
        kind: CompletionItemKind.Constant,
        label: 'trigger.extin.overrun',
    },
    {
        detail: 'This function waits for a trigger.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'This function pauses for up to timeout seconds for an input trigger. If one or more trigger events are detected since the last time trigger.extin.wait() or trigger.extin.clear() was called, this function returns a value immediately. After waiting for a trigger with this function, the event detector is automatically reset and is ready to detect the next trigger. This is true regardless of the number of events detected.'
        },
        kind: CompletionItemKind.Function,
        label: 'trigger.extin.wait',
    },
    {
        detail: 'This function asserts a trigger on the EXTERNAL TRIGGER OUT line.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'Initiates a trigger event and does not wait for completion.'
        },
        kind: CompletionItemKind.Function,
        label: 'trigger.extout.assert',
    },
    {
        detail: 'This attribute sets the output logic of the trigger event generator to positive or negative for the EXTERNAL TRIGGER OUT line.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'This command sets the trigger event generator to assert a TTL pulse for output logic. Positive is a high pulse; negative is a low pulse.'
        },
        kind: CompletionItemKind.Property,
        label: 'trigger.extout.logic',
    },
    {
        detail: 'This attribute selects the event that causes a trigger to be asserted on the EXTERNAL TRIGGER OUT line.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'The trigger stimulus for the EXTERNAL TRIGGER OUT line can be set to one of the trigger events described in the following table.'
        },
        kind: CompletionItemKind.Property,
        label: 'trigger.extout.stimulus',
    },
    {
        detail: 'This function clears the event detector for a LAN trigger.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'The trigger event detector enters the detected state when an event is detected. This function clears a trigger event detector and discards the previous history of the trigger packet.\n\nThis function clears all overruns associated with this LAN trigger.'
        },
        kind: CompletionItemKind.Function,
    ...
    {
        detail: 'This attribute specifies the address (in dotted-decimal format) of UDP or TCP listeners.',
        documentation: {
            kind: MarkupKind.Markdown,
    ...
    {
        detail: 'This function stops all trigger model commands and scans on the instrument.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'When this command is received, the instrument stops the trigger model and scans.'
        },
        kind: CompletionItemKind.Function,
    ...
    {
        detail: 'This function starts the trigger model  or scan.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: ''
        },
    ...
    },
    {
        ...
        kind: CompletionItemKind.Function,
        label: 'trigger.model.load() - DurationLoop',
    },
    {
    ...
    },
    {
        ...
        kind: CompletionItemKind.Function,
        label: 'trigger.model.load() - GradeBinning',
    },
    {
        detail: 'This function loads a predefined trigger model configuration that sets up a logic trigger through the digital or external I/O.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'This trigger model waits for a digital input or external trigger input event to occur, makes a measurement, and issues a notify event. If a digital output line is selected, a notify event asserts a digital output line. A notify event asserts the external output line regardless of the line settings. You can set the line to 7 to assert only the external output line, or to another setting to assert both a digital output line and the external output line.\n\nAfter selecting a trigger model template, you can view the trigger model blocks in a graphical format by pressing the front-panel MENU key and under Trigger, selecting Configure. You can also add or delete blocks and change trigger model settings from this screen. You can use the trigger.model.getblocklist() command to view the trigger model blocks in a list format.'
        },
        kind: CompletionItemKind.Function,
        label: 'trigger.model.load() - LogicTrigger',
    },
    {
    ...
    },
    {
        ...
        kind: CompletionItemKind.Function,
        label: 'trigger.model.load() - SimpleLoop',
    },
    {
        ...
        kind: CompletionItemKind.Function,
        label: 'trigger.model.load() - SortBinning',
    },
    {
        detail: 'This function pauses a running scan.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'This command pauses the scan.\n\nTo continue the trigger model and the scan, send the resume command.'
        },
        kind: CompletionItemKind.Function,
        label: 'trigger.model.pause',
    },
    {
        detail: 'This function continues a paused scan or trigger model.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'This command continues running the scan or trigger model operation if the scan or trigger model was paused.'
        },
        kind: CompletionItemKind.Function,
        label: 'trigger.model.resume',
    },
    {
        detail: 'This function defines a trigger model block that always goes to a specific block.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'When the trigger model reaches a branch-always building block, it goes to the building block set by branchToBlock.'
        },
        kind: CompletionItemKind.Function,
        label: 'trigger.model.setblock() - trigger.BLOCK_BRANCH_ALWAYS',
    },
    {
        ...
        kind: CompletionItemKind.Function,
        label: 'trigger.model.setblock() - trigger.BLOCK_BRANCH_COUNTER',
    },
    {
    ...
    },
    {
        ...
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'The branch-once building block branches to a specified block the first time trigger model execution encounters the branch-once block. If it is encountered again, the trigger model ignores the block and continues in the normal sequence.\n\nThe once block is reset when trigger model execution reaches the idle state. Therefore, the branch-once block always executes the first time the trigger model execution encounters this block.'
        },
        kind: CompletionItemKind.Function,
        label: 'trigger.model.setblock() - trigger.BLOCK_BRANCH_ONCE',
    },
    {
        ...
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'The branch-once-excluded block is ignored the first time the trigger model encounters it. After the first encounter, the trigger model goes to the specified branching block.\n\nThe branch-once-excluded block is reset when the trigger model starts or is placed in idle.'
        },
        kind: CompletionItemKind.Function,
        label: 'trigger.model.setblock() - trigger.BLOCK_BRANCH_ONCE_EXCLUDED',
    },
    {
        ...
        kind: CompletionItemKind.Function,
        label: 'trigger.model.setblock() - trigger.BLOCK_BRANCH_ON_EVENT',
    },
    {
    ...
    },
    {
        ...
        kind: CompletionItemKind.Function,
        label: 'trigger.model.setblock() - trigger.BLOCK_DELAY_CONSTANT',
    },
    {
        detail: 'This function adds a user delay to the execution of the trigger model.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'Each measure function can have up to five unique user delay times (M1 to M5). Digitize user delays are handled as measure user delays, so you can have a total of five measure and digitize user delays. The delay time is set by the user-delay command, which is only available over a remote interface.\n\nThough the trigger model can be used with any function, the user delay is set per function. Make sure you are setting the delay for the function you intend to use with the trigger model. The measure user-delay settings are used with measure functions; the digitize user-delay functions are used with digitize functions.'
        },
        kind: CompletionItemKind.Function,
        label: 'trigger.model.setblock() - trigger.BLOCK_DELAY_DYNAMIC',
    },
    {
        ...
        kind: CompletionItemKind.Function,
        label: 'trigger.model.setblock() - trigger.BLOCK_DIGITAL_IO',
    },
    {
        ...
        kind: CompletionItemKind.Function,
        label: 'trigger.model.setblock() - trigger.BLOCK_LOG_EVENT',
    },
    {
        detail: 'This function defines a trigger block that makes or digitizes a measurement.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'When you set the count to auto, the trigger model uses the count value that is active for the selected function instead of a specific value. You can use this with configuration lists to change the count value each time a measure/digitize block is encountered.'
        },
        kind: CompletionItemKind.Function,
        label: 'trigger.model.setblock() - trigger.BLOCK_MEASURE_DIGITIZE',
    },
    {
        ...
        kind: CompletionItemKind.Function,
        label: 'trigger.model.setblock() - trigger.BLOCK_NOP',
    },
    {
        ...
        kind: CompletionItemKind.Function,
        label: 'trigger.model.setblock() - trigger.BLOCK_NOTIFY',
    },
    {
        ...
        kind: CompletionItemKind.Function,
        label: 'trigger.model.setblock() - trigger.BLOCK_RESET_BRANCH_COUNT',
    },
    {
        detail: 'This function defines a trigger model block that waits for an event before allowing the trigger model to continue.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'You can use the wait block to synchronize measurements with other instruments and devices.\n\nYou can set the instrument to wait for the events shown in the following table.'
        },
        kind: CompletionItemKind.Function,
        label: 'trigger.model.setblock() - trigger.BLOCK_WAIT',
    },
    {
    ...
    },
    {
        ...
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'Set this command to any trigger event to start the timer when that event occurs.\n\nSet this command to none to disable event processing and use the timer as a timer or alarm based on the start time.\n\nTrigger events are described in the table below.'
        },
        kind: CompletionItemKind.Property,
    ...
    },
    {
        ...
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'The trigger event detector enters the detected state when an event is detected. When this command is sent, the instrument:'
        },
        kind: CompletionItemKind.Function,
    ...
    {
        detail: 'This function releases a latched trigger on the given TSP-Link trigger line.',
        documentation: {
            kind: MarkupKind.Markdown,
...
const triggerSignatures: Array<SignatureInformation> = [
    ...
    SignatureInformation.create(
        'trigger.extin.wait(triggered, timeout)',
        undefined,
        ParameterInformation.create(
            'triggered',
            'Trigger detected: true\nNo triggers detected during the timeout period: false.'
    ...
    SignatureInformation.create(
        ...
        ParameterInformation.create(
            'duration',
            'The amount of time for which to make measurements (500 ns to 100ks).'
        ),
        ParameterInformation.create(
            'delay',
            'The delay time before each measurement (167ns to 10ks); default is 0 for no delay.'
    ...
    SignatureInformation.create(
        'trigger.model.load() - GradeBinning(x, x)',
        undefined,
        ParameterInformation.create(
            'x',
    ...
    SignatureInformation.create(
        ...
        ParameterInformation.create(
            'digInLine',
            'The digital input line (1 to 6) or external input line (7); also the event that the trigger model will wait on in block1.'
        ),
        ParameterInformation.create(
            'digOutLine',
    ...
    SignatureInformation.create(
        'trigger.model.load() - LoopUntilEvent(triggerEvent, position, clear, bufferName)',
        undefined,
        ParameterInformation.create(
            'triggerEvent',
    ...
    SignatureInformation.create(
        'trigger.model.load() - SortBinning(x, x)',
        undefined,
        ParameterInformation.create(
            'x',
            'x is limit 1, 2, 3, or 4; the upper limit that the measurement is compared against.'
    ...
    SignatureInformation.create(
        'trigger.model.setblock() - trigger.BLOCK_BRANCH_ALWAYS(blockNumber, branchToBlock)',
        undefined,
        ParameterInformation.create(
            'blockNumber',
            'The sequence of the block in the trigger model.'
        ...
        ParameterInformation.create(
            'branchToBlock',
            'The block number to execute when the trigger model reaches the Branch Always block.'
        ),
    ),
    SignatureInformation.create(
    ...
    SignatureInformation.create(
        'trigger.model.setblock() - trigger.BLOCK_DELAY_DYNAMIC(blockNumber, blockNumber, n, n, N, N, N)',
        undefined,
        ParameterInformation.create(
            'blockNumber',
            'The sequence of the block in the trigger model.'
        ...
        ParameterInformation.create(
            'n',
            'The number of the user delay, 1 to 5, set by dmm.measure.userdelay[N] or dmm.digitize.userdelay[N].'
        ),
        ParameterInformation.create(
            'n',
            'n.'
    ...
    SignatureInformation.create(
        ...
        ParameterInformation.create(
            'eventNumber',
            'The event number:\ntrigger.LOG_INFON\ntrigger.LOG_WARNN\ntrigger.LOG_ERRORNWhere N is 1 to 4; you can define up to four of each type.\nYou can also set trigger.LOG_WARN_ABORT, which aborts the trigger model immediately and posts a warning event log message.'
        ),
        ParameterInformation.create(
            'N',
            'trigger.LOG_INFONtrigger.LOG_WARNNtrigger.LOG_ERRORNWhere N is 1 to 4; you can define up to four of each type\nYou can also set trigger.LOG_WARN_ABORT, which aborts the trigger model immediately and posts a warning event log message.'
        ),
        ParameterInformation.create(
            'N',
            'The event number:.'
    ...
    SignatureInformation.create(
        'trigger.model.setblock() - trigger.BLOCK_MEASURE_DIGITIZE(blockNumber, bufferName, count)',
        undefined,
        ParameterInformation.create(
            'blockNumber',
            'The sequence of the block in the trigger model.'
        ...
        ParameterInformation.create(
            'count',
            'The number of digitize digitize readings to make before moving to the next block in the trigger model; set to:\nA specific value\nInfinite (run continuously until stopped): trigger.COUNT_INFINITE\nStop infinite to stop the block: trigger.COUNT_STOP\nUse most recent count value: trigger.COUNT_AUTO.'
        ),
    ),
    SignatureInformation.create(
