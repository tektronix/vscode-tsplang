...
const fileCompletions: Array<CompletionItem> = [
    ...
    {
        detail: 'This function writes buffering data to a file on the USB flash drive.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'The file.write() function may be buffering data instead of writing immediately to the USB flash drive. Use file.flush() to flush this data. Data may be lost if the file is not closed or flushed before a script ends.\n\nIf there is going to be a time delay before more data is written to a file, flush the file to prevent loss of data because of an aborted test.'
        },
        kind: CompletionItemKind.Function,
        label: 'file.flush',
    },
    {
        ...
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'The directory path must be absolute. The name of the directory must not already exist on the flash drive.'
        },
        kind: CompletionItemKind.Function,
        label: 'file.mkdir',
    },
    ...
    },
    {
        ...
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'The file.write() function may include data that is buffering; it may not be written to the USB flash drive immediately. Use the file.flush() function to immediately write buffered data to the drive.\n\nYou must use the file.close() command to close the file after writing.'
        },
        kind: CompletionItemKind.Function,
        label: 'file.write',
    },
