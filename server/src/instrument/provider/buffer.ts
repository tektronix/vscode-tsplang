...
export const completions: Array<CompletionItem> = [
    ...
    },
    {
        ...
        documentation: {
            ...
            value: '```lua\nfunction channelmath(bufferName, unit, channelNumber, expression)\n\
```\n\nbuffer.channelmath(bufferName, unit, channelNumber, buffer.EXPR_*)\n\
\n\
Apply a mathematical expression of type buffer.EXPR_* to a measurement from a scan card as it is placed into the \
specified reading buffer. The result of the expression is then placed in the Extra column of the reading buffer.\n\
\n\
...
You cannot assign user-defined reading buffers the name defbuffer1 and defbuffer2.'
    ...
    },
    {
        ...
        documentation: {
            kind: MarkupKind.Markdown,
            value: '```lua\nfunction math(bufferName, unit, expression)\n```\n\
\n\
buffer.math(bufferName, buffer.UNIT_\\*, buffer.EXPR_\\*)\n\
\n\
Apply a mathematical expression of type buffer.EXPR_* to a measurement as it is placed into the specified \
reading buffer. The result of the expression is then placed in the Extra column of the reading buffer.\n\
\n\
...
export const signatures: Array<SignatureInformation> = [
    {
        ...
        label: 'buffer.channelmath(bufferName, unit, channelNumber, expression)',
        parameters: [
            {
                documentation: 'String that contains the name of the reading buffer to apply the \
mathematical expression to; cannot be a default buffer; must be set to the style buffer.STYLE_FULL ',
                label: 'bufferName',
            },
            {
...
list syntax; this is also the channel that supplies the r value in the expressions.',
    ...
    },
    {
        ...
        label: 'buffer.channelmath(bufferName, unit, channelNumber, expression, channelNum2)',
        parameters: [
            {
                documentation: 'String that contains the name of the reading buffer to apply the \
mathematical expression to; cannot be a default buffer; must be set to the style buffer.STYLE_FULL ',
...
expressions that require a previous measurement.',
    ...
    },
    {
        ...
        label: 'buffer.channelmath(bufferName, unit, channelNumber, buffer.EXPR_POWER, constant0)',
        parameters: [
            {
                documentation: 'String that contains the name of the reading buffer to apply the \
mathematical expression to; cannot be a default buffer; must be set to the style buffer.STYLE_FULL ',
...
list syntax; this is also the channel that supplies the r value in the expressions',
    ...
    },
    {
        ...
        label: 'buffer.channelmath(bufferName, unit, channelNumber, buffer.EXPR_POLY, constant0, \
...
WRITABLE buffers are used to import external data and cannot be used to collect readings from the instrument.',
    ...
    },
    {
        ...
        documentation: 'For most expressions.',
        label: 'buffer.math(bufferName, unit, expression)',
        parameters: [
            {
                documentation: 'String that contains the name of the reading buffer to apply the \
mathematical expression to; cannot be a default buffer; must be set to the style buffer.STYLE_FULL ',
...
given as some buffer.UNIT_*',
    ...
    },
    {
        ...
        documentation: 'For the buffer.EXPR_POWER expression which requires a constant.',
        label: 'buffer.math(bufferName, unit, buffer.EXPR_POWER, constant)',
        parameters: [
            {
                documentation: 'String that contains the name of the reading buffer to apply the \
mathematical expression to; cannot be a default buffer; must be set to the style buffer.STYLE_FULL ',
...
given as some buffer.UNIT_*',
    ...
    },
    {
        ...
        label: 'buffer.math(bufferName, unit, buffer.EXPR_POLY, constant0, constant1, constant2, constant3, \
c4onstant, constant5)',
        parameters: [
            {
                documentation: 'String that contains the name of the reading buffer to apply the \
