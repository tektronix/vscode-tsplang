...
\n\
Get or set the beeper behavior for the indexed limit to smu.AUDIBLE_\\*. Defaults to smu.AUDIBLE_NONE.\n\
\n\
...
\n\
smu.digitize.limit[Y].fail -> smu.FAIL_\\*\n\
\n\
Returns the result of the limit test for the indexed limit. If limit autoclear is enabled, then this attribute is \
cleared after being accessed. This attribute is always cleared when changing digitize functions.'
        },
