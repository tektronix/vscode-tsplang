...
namespace Smu {
    const smuEnumAperture: ExclusiveCompletionApiSpec = { label: 'smu.APERTURE_AUTO' }
    namespace Func {
        ...
        export const DIGITIZE_CURRENT: ExclusiveCompletionApiSpec = { label: 'smu.FUNC_DIGITIZE_CURRENT' }
        export const DIGITIZE_VOLTAGE: ExclusiveCompletionApiSpec = { label: 'smu.FUNC_DIGITIZE_VOLTAGE' }
    ...
    const smuEnumFuncDigitize: Array<ExclusiveCompletionApiSpec> = [
        Func.DIGITIZE_CURRENT,
        Func.DIGITIZE_VOLTAGE
    ]
    ...
    const smuEnumThreshold: Array<ExclusiveCompletionApiSpec> = [
        { label: 'smu.THRESHOLD_2_OHM' },
        { label: 'smu.THRESHOLD_15_OHM' },
        { label: 'smu.THRESHOLD_50_OHM' },
    ]
    ...
    export const smuContact: ApiSpec = {
        children: [
            ...
            {
                assignmentExclusives: smuEnumThreshold,
    ...
    export const smuDigitizeLimitHigh: ApiSpec = {
        children: [
            { label: 'smu.digitize.limit.high.value' },
        ],
        label: 'smu.digitize.limit.high'
    }

    export const smuDigitizeLimitLow: ApiSpec = {
        children: [
            { label: 'smu.digitize.limit.low.value' },
        ],
        label: 'smu.digitize.limit.low'
    }

    export const smuDigitizeLimit: ApiSpec = {
        children: [
            {
                assignmentExclusives: smuEnumAudible,
                label: 'smu.digitize.limit.audible'
            },
            {
                assignmentExclusives: smuEnumOnOff,
                label: 'smu.digitize.limit.autoclear'
            },
            { label: 'smu.digitize.limit.clear' },
            {
                assignmentExclusives: smuEnumOnOff,
                label: 'smu.digitize.limit.enable'
            },
            {
                assignmentExclusives: smuEnumFail,
                label: 'smu.digitize.limit.fail'
            },
        ],
        label: 'smu.digitize.limit'
    }

    export const smuDigitizeMathMxb: ApiSpec = {
        children: [
            { label: 'smu.digitize.math.mxb.bfactor' },
            { label: 'smu.digitize.math.mxb.mfactor' },
        ],
        label: 'smu.digitize.math.mxb'
    }

    export const smuDigitizeMath: ApiSpec = {
        children: [
            {
                assignmentExclusives: smuEnumOnOff,
        ...
        label: 'smu.digitize.math'
    }

    export const smuDigitizeRel: ApiSpec = {
        children: [
        ...
        label: 'smu.digitize.rel'
    }

    export const smuDigitize: ApiSpec = {
        children: [
            {
                assignmentExclusives: [smuEnumAperture],
            ...
            {
                assignmentExclusives: smuEnumFuncDigitize,
    ...
    export const smuSourcePulseIlimit: ApiSpec = {
        children: [
            { label: 'smu.source.pulse.ilimit.level' }
        ],
        label: 'smu.source.pulse.ilimit'
    }

    export const smuSourcePulseVlimit: ApiSpec = {
        children: [
            { label: 'smu.source.pulse.vlimit.level' }
        ],
        label: 'smu.source.pulse.vlimit'
    }

    export const smuSourcePulse: ApiSpec = {
        children: [
            { label: 'smu.source.pulse.level' }
        ],
        label: 'smu.source.pulse'
    }
...
namespace Trigger {
    namespace Block {
        ...
        export const DIGITIZE: ExclusiveCompletionApiSpec = { label: 'trigger.BLOCK_DIGITIZE' }
        ...
        export const SOURCE_PULSE_OUTPUT: ExclusiveCompletionApiSpec = { label: 'trigger.BLOCK_SOURCE_PULSE_OUTPUT' }
...
export function getApiSpec(): Array<ApiSpec> {
    return [
        ...
        Smu.smuContact,
        Smu.smuInterlock,
        Smu.smuDigitizeLimitHigh,
        Smu.smuDigitizeLimitLow,
        Smu.smuDigitizeLimit,
        Smu.smuDigitizeMathMxb,
        Smu.smuDigitizeMath,
        Smu.smuDigitizeRel,
        Smu.smuDigitize,
        ...
        Smu.smuSourcePulseIlimit,
        Smu.smuSourcePulseVlimit,
        Smu.smuSourcePulse,
        Smu.smuSourceVlimit,
        Smu.smuSource,
        Smu.smu,
...
export function getInstrumentSpec(): InstrumentSpec {
    return {
        ...
        defaults: {
            contact: {
                threshold: 'smu.THRESHOLD_50_OHM'
            },
            digitize: {
                range: {
                    current: 100e-3,
        ...
        extendedRanges: {
            current: [1e-6, 10e-6, 100e-6, 1e-3, 10e-3, 100e-3, 1, 4, 5, 7, 10],
