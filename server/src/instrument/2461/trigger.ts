...
const triggerCompletions: Array<CompletionItem> = [
    ...
    },
    {
        ...
        kind: CompletionItemKind.Function,
        label: 'trigger.model.load() — Config List',
    },
    {
        ...
        kind: CompletionItemKind.Function,
        label: 'trigger.model.load() — Duration Loop',
    },
    {
    ...
    },
    {
        ...
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'The measure or digitize block must occur in the trigger model before the branch-on-dynamic-limits block. If no measure or digitize block is defined, the measurement from the previous measure or digitize block is used. If no previous measure or digitize block exists, an error is reported.'
        },
        kind: CompletionItemKind.Function,
    ...
    {
        detail: 'This function defines a trigger block that makes a measurement using a digitize function.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'When you set the count to a finite value, trigger model execution remains at the block until all measurements are complete. If you set the count to infinite, the trigger model executes subsequent blocks and measurements continue in the background until the trigger model execution reaches another digitize block or until the trigger model ends.\n\nA digitize function (digitize voltage or digitize current) must be selected before you run a trigger model that contains this block. You cannot have a measure block and a digitize block in the same trigger model.'
        },
        kind: CompletionItemKind.Function,
        label: 'trigger.model.setblock() — trigger.BLOCK_DIGITIZE',
    },
    {
    ...
    },
    {
        ...
        kind: CompletionItemKind.Function,
        label: 'trigger.model.setblock() — trigger.BLOCK_MEASURE',
    },
    {
    ...
    },
    {
        ...
        kind: CompletionItemKind.Function,
        label: 'trigger.model.setblock() — trigger.BLOCK_SOURCE_OUTPUT',
    },
    {
        detail: 'This function defines a pulse trigger block that turns the pulse source on or off.',
        documentation: {
            kind: MarkupKind.Markdown,
            value: 'When you list trigger blocks, this block is listed as PULSE_OUTPUT.'
        },
        kind: CompletionItemKind.Function,
        label: 'trigger.model.setblock() — trigger.BLOCK_SOURCE_PULSE_OUTPUT',
    },
    {
...
const triggerSignatures: Array<SignatureInformation> = [
    ...
    SignatureInformation.create(
        'trigger.model.load() — Config List(measureConfigList, sourceConfigList, sDelay, bufferName, readingBlock)',
        undefined,
        ParameterInformation.create(
            'measureConfigList',
        ...
        ParameterInformation.create(
            'readingBlock',
            'Define a measure or digitize block for the trigger model; options are:\ntrigger.READING_ACTIVE: Add a measure or digitize block to the trigger model based on the active function; if no option defined, trigger.READING_ACTIVE is used\ntrigger.READING_MEASURE: Adds a measure block to the trigger model\ntrigger.READING_DIGITIZE: Adds a digitize block to the trigger model.'
        ),
    ),
    SignatureInformation.create(
        'trigger.model.load() — Duration Loop(duration, sDelay, bufferName, readingBlock)',
        undefined,
        ParameterInformation.create(
            'duration',
    ...
    SignatureInformation.create(
        'trigger.model.load() — LogicTrigger(digInLine, digOutLine, count, clear, sDelay, bufferName, readingBlock)',
        undefined,
        ParameterInformation.create(
            'digInLine',
    ...
    SignatureInformation.create(
        'trigger.model.load() — LoopUntilEvent(triggerEvent, position, clear, bufferName, readingBlock)',
        undefined,
        ParameterInformation.create(
            'triggerEvent',
    ...
    SignatureInformation.create(
        'trigger.model.load() — SimpleLoop(count, sDelay, bufferName, readingBlock)',
        undefined,
        ParameterInformation.create(
            'count',
            'The number of measurements the instrument will make.'
    ...
    SignatureInformation.create(
        ...
        ParameterInformation.create(
            'measureBlock',
            'The block number of the measure or digitize block that makes the measurements to be compared; if this is 0 or undefined, the trigger model uses the previous measure or digitize block.'
        ),
    ),
    SignatureInformation.create(
    ...
    SignatureInformation.create(
        'trigger.model.setblock() — trigger.BLOCK_CONFIG_NEXT(blockNumber, configurationList, optionalConfigList)',
        undefined,
        ParameterInformation.create(
            'blockNumber',
            'The sequence of the block in the trigger model.'
        ...
        ParameterInformation.create(
            'optionalConfigList',
            'The name of the second configuration list to recall the index from; must be the opposite type of list than the first; for example, if the first configuration list is a measure list, the second configuration list must be a source list.'
        ),
    ),
    SignatureInformation.create(
        'trigger.model.setblock() — trigger.BLOCK_CONFIG_PREV(blockNumber, configurationList, optionalConfigList)',
        undefined,
        ParameterInformation.create(
            'blockNumber',
            'The sequence of the block in the trigger model.'
        ...
        ParameterInformation.create(
            'optionalConfigList',
            'A string that defines the second configuration list to recall the index from; must be the opposite type of list than the first; for example, if the first configuration list is a measure list, the second configuration list must be a source list.'
        ),
    ),
    SignatureInformation.create(
        'trigger.model.setblock() — trigger.BLOCK_CONFIG_RECALL(blockNumber, configurationList, index, optionalConfigList, optionalIndex)',
        undefined,
        ParameterInformation.create(
            'blockNumber',
            'The sequence of the block in the trigger model.'
    ...
    SignatureInformation.create(
        'trigger.model.setblock() — trigger.BLOCK_DELAY_DYNAMIC(blockNumber, blockNumber, userDelay, userDelay, n, n, n, n, N, n, n, n, n, N, N, n, n, n, n)',
        undefined,
        ParameterInformation.create(
            'blockNumber',
            'The sequence of the block in the trigger model.'
        ...
        ParameterInformation.create(
            'n',
            'trigger.USER_DELAY_Mn, where n is the number of the user delay (1 to 5) set by smu.measure.userdelay[N]trigger.USER_DELAY_Sn, where n is the number of the user delay (1 to 5) set by smu.source.userdelay[N]trigger.USER_DELAY_Mn, where n is the number of the user delay (1 to 5) set by smu.digitize.userdelay[N].'
        ),
        ParameterInformation.create(
            'n',
            'trigger.USER_DELAY_Mn, where n is the number of the user delay (1 to 5) set by smu.digitize.userdelay[N].'
        ...
        ParameterInformation.create(
            'n',
            'trigger.USER_DELAY_Mn, where n is the number of the user delay (1 to 5) set by smu.digitize.userdelay[N] trigger.USER_DELAY_Sn, where n is the number of the user delay (1 to 5) set by smu.source.userdelay[N]trigger.USER_DELAY_Mn, where n is the number of the user delay (1 to 5) set by smu.measure.userdelay[N].'
        ),
        ParameterInformation.create(
            'n',
            'trigger.USER_DELAY_Mn, where n is the number of the user delay (1 to 5) set by smu.measure.userdelay[N].'
    ...
    SignatureInformation.create(
        'trigger.model.setblock() — trigger.BLOCK_DIGITIZE(blockNumber, bufferName, count)',
        undefined,
        ParameterInformation.create(
            'blockNumber',
            'The sequence of the block in the trigger model.'
        ...
        ParameterInformation.create(
            'count',
            'The number of measure readings to make before moving to the next block in the trigger model; set to a specific value or infinite (trigger.COUNT_INFINITE) or stop infinite (trigger.COUNT_STOP).'
        ),
    ),
    SignatureInformation.create(
    ...
    SignatureInformation.create(
        'trigger.model.setblock() — trigger.BLOCK_SOURCE_PULSE_OUTPUT(blockNumber, state)',
        undefined,
        ParameterInformation.create(
            'blockNumber',
            'The sequence of the block in the trigger model.'
        ...
        ParameterInformation.create(
            'state',
            'Turn the source pulse off: smu.OFF\nTurn the source pulse on: smu.ON.'
        ),
    ),
    SignatureInformation.create(
