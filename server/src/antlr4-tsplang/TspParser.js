...
TspParser.prototype.block = function() {
    ...
    try {
        ...
        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << TspParser.T__2) | (1 << TspParser.T__4) | (1 << TspParser.T__5) | (1 << TspParser.T__7) | (1 << TspParser.T__11) | (1 << TspParser.T__12) | (1 << TspParser.T__15) | (1 << TspParser.T__16) | (1 << TspParser.T__19))) !== 0) || _la===TspParser.LOCAL || _la===TspParser.NAME) {
            this.state = 79;
            this.statement();
            this.state = 81;
            this._errHandler.sync(this);
...
ExpressionContext.prototype.functionDefinition = function() {
...
TspParser.prototype.args = function() {
    ...
    try {
        ...
        case TspParser.T__19:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << TspParser.T__15) | (1 << TspParser.T__19) | (1 << TspParser.T__23))) !== 0) || ((((_la - 37)) & ~0x1f) == 0 && ((1 << (_la - 37)) & ((1 << (TspParser.T__36 - 37)) | (1 << (TspParser.T__44 - 37)) | (1 << (TspParser.T__45 - 37)) | (1 << (TspParser.NIL - 37)) | (1 << (TspParser.BOOLEAN - 37)) | (1 << (TspParser.NAME - 37)) | (1 << (TspParser.NORMALSTRING - 37)) | (1 << (TspParser.CHARSTRING - 37)) | (1 << (TspParser.LONGSTRING - 37)) | (1 << (TspParser.INT - 37)) | (1 << (TspParser.HEX - 37)) | (1 << (TspParser.FLOAT - 37)))) !== 0)) {
                this.state = 319;
                this.expressionList();
            }
...
TspParser.prototype.tableConstructor = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << TspParser.T__15) | (1 << TspParser.T__19) | (1 << TspParser.T__21) | (1 << TspParser.T__23))) !== 0) || ((((_la - 37)) & ~0x1f) == 0 && ((1 << (_la - 37)) & ((1 << (TspParser.T__36 - 37)) | (1 << (TspParser.T__44 - 37)) | (1 << (TspParser.T__45 - 37)) | (1 << (TspParser.NIL - 37)) | (1 << (TspParser.BOOLEAN - 37)) | (1 << (TspParser.NAME - 37)) | (1 << (TspParser.NORMALSTRING - 37)) | (1 << (TspParser.CHARSTRING - 37)) | (1 << (TspParser.LONGSTRING - 37)) | (1 << (TspParser.INT - 37)) | (1 << (TspParser.HEX - 37)) | (1 << (TspParser.FLOAT - 37)))) !== 0)) {
            this.state = 347;
            this.fieldList();
        }
